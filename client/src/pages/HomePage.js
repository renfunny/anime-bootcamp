        ...
        <>
            <div className="container">
                ...
                <div className="anime-section">
                    ...
                    <Carousel>
                        <Carousel.Item>
                            <img className="d-block w-100" src="https://www.denofgeek.com/wp-content/uploads/2022/04/FPbgN6-XwAsJfar.jpeg?resize=732,1024" alt="First slide" />
                            <Carousel.Caption>
                        ...
                        <Carousel.Item>
                            <img className="d-block w-100" src="https://sportshub.cbsistatic.com/i/2022/06/08/94653059-d16f-4567-b63a-a924c90af88f/vinland-saga-season-2.jpg?auto=webp&width=707&height=1000&crop=0.707:1,smart" alt="Second slide" />
                            <Carousel.Caption>
                                <h3>Vinland Saga</h3>
                                <p>Airing Now!</p>
                            </Carousel.Caption>
                    ...
                    <div className="container d-flex">
                        <Card style={{ width: '18rem' }}>
                            <Card.Body>
                                ...
                                <Card.Link target="_blank" href="https://www.viz.com/shonenjump">Viz/shonenjump</Card.Link>
                                <Card.Link target="_blank" href="https://myanimelist.net/anime/genre/27/Shounen">MAL</Card.Link>
                            </Card.Body>
                        </Card>
                        <Card style={{ width: '18rem' }}>
                            <Card.Body>
                                ...
                                <Card.Link target="_blank" href="https://myanimelist.net/anime/genre/22/Romance">MAL</Card.Link>
                            </Card.Body>
                        </Card>
                        <Card style={{ width: '18rem' }}>
                            <Card.Body>
                                ...
                                <Card.Link target="_blank" href="https://myanimelist.net/anime/genre/36/Slice_of_Life">MAL</Card.Link>
                            </Card.Body>
                        </Card>
                    </div>
